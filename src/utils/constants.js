...
export const services = [
  ...
  },
  {
    ...
    icon: <GiDiamondHard />,
    title: 'vision',
    text: 'Our vision is to take ejae to greater heights, by providing our customers best in class service.',
  },
  {
    id: 3,
    icon: <GiStabbedNote />,
    title: 'history',
    text: `ejae was started in December'21 with an initial aim to provide the best in class services to our customers.`,
  },
];
